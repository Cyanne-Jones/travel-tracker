...
describe('Destination Repository', () => {
  ...
  it('Should hold an array of destinations', () => {
    expect(destinationRepository.destinations).to.deep.equal(
      [{
        "id": 1,
  ...
  it('Should be able to return a destination by an id number', () => {
    expect(destinationRepository.getDestinationById(4)).to.deep.equal(
      {
        "id": 4,
        "destination": "c",
        "estimatedLodgingCostPerDay": 65,
